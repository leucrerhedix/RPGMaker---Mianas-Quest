...
(function() {
	...
	var descriptionList = {
		...
		'item': ["", "\\I[210]Inventory"],
		'skill': ["", "\\I[78]Skills"],
		'equip': ["", "\\I[137]Equipment"],
		'status': ["", "\\I[193]Stats"],
		'formation': ["", "\\I[82]Party Order"],
		'options': ["", "\\I[83]Settings"],
		'save': ["", "\\I[79]Save"],
		'gameEnd': ["", "\\I[91]Quit"] 
	};
	/* --------------------------------------------------------------------------------
	...
	var paramHelpWndW = String(parameters['Help Window Width'] || "this._commandWindow.width + 170");
	...
	Window_MenuCommand.prototype.windowWidth = function() {
	    return this._list.length * Window_Base._iconWidth + this.standardPadding() * 5;
	};
